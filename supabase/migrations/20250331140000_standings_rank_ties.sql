-- Use RANK() so tied scores share the same place (e.g. three people at 2 pts are all rank 1; next score skips to 4).
-- List order within a tie: alphabetical by display_name.
