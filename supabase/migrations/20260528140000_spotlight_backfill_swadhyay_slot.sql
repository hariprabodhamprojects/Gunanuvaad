-- When the second Swadhyay slot would be empty or duplicate (e.g. only one post in
-- the 7-day pool), fill that carousel position with an extra ghun or Smruti instead.
-- Combines: full body text (281300), dedupe (281200), allowlist names (231500).
...
begin
  ...
  -- Sixth slot: second Swadhyay, or backfill with another ghun / Smruti.
  v_slot_sw2 := null;
